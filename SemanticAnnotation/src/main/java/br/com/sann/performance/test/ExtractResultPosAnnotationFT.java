...
public class ExtractResultPosAnnotationFT {
	...
	public ExtractResultPosAnnotationFT() {
	...
	public static void main(String[] args) {
		...
		ExtractResultPosAnnotationFT performanceTest = new ExtractResultPosAnnotationFT();
