...
public class SearcherConceptysDBPedia {
	 ...
	 * 
	 * @param text O texto a ser consultado.
	 * @return O texto pr�-processado e a lista de super classes e super categorias referentes ao mesmo.
	 */
	...
	/**
	 * M�todo para extrair os labels das categorias.
	...
	/**
	 * Método para extrair os labels e as url das classes.
	...
	/**
	 * Método para extrair os labels e as url das categorias.
	 * @param categories As categoias a serem exploradas.
	...
	/**
	 * M�todo para extrair os labels das classes.
	 * @param categories As categoias a serem exploradas.
	 * @return Os labels das categorias
	 */
	...
	private void loadPropertyOwlDBPedia() {
		try {
			...
			System.err.println("N�o foi poss�viel localizar o OWL da DBPedia.");
		}
	}
	...
	private List<String> recoveryAssociateConcepts(String concept) {
		...
		try {
			...
			System.err.println("N�o foi poss�vel carregar o OWL da DBPedia.");;
		} catch (ResourceNotFoundException e) {
			System.err.println("N�o foi poss�vel encontrar recursos referente ao conceito " + concept);
		}
		return result;
	}
	
	/**
	 * M�todo para acrescentar os conceitos associados ao conceitos.
	...
	private Set<String> recoveryAssociateCategories(String category) {
		...
		try {
			...
			System.err.println("N�o foi poss�vel encontrar recursos referente � categoria " + category);
		}
		return result;
	}
	/**
	 * M�todo para acrescentar as categorias associadas �s categorias recuperadas.
	 * @param concepts Os conceitos.
	 * @return Os conceitos e os seus respectivos associados.
	 */
